...
`substitute-workflow-phase-1`, and
`season-teams-error-and-rules-echo-fixes` are all done (see the Critical
...
1. Deciding whether "Generate Schedule" needs an undo path (#9) --
   likely only worth it if a real workflow (not just this smoke test)
   hits it.
